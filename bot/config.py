...
class Messages:
    START_MSG = "**Hi there {}.**\n__I'm Nami, Google Drive Uploader Bot.You can use me to upload any file / video to Google Drive from direct link or Telegram Files.__\n__You can know more from /help.__"
    ...
    HELP_MSG = [
        ...
        "**Developed by @viperadnan forked by @straw_hat**"
        ]
